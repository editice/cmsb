 ...
 */
public class YyRmzlAllRankGen extends GraphGenerator {

    public static final BizKey YyCwsAllRankGen = new BizKey(93, "医院全国日门诊量排名", "line");

    List<YiyuanCntDO> yiyuanCntDOs=Lists.newArrayList();

    public YyRmzlAllRankGen(GraphIn graphIn) {
        super(graphIn);
