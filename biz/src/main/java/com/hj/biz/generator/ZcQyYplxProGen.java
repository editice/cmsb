 ...
 */
public class ZcQyYplxProGen extends GraphGenerator{

    public static final BizKey ZcQyYplxProGen=new BizKey(111,"药品类型分类","pie");

    Map<String,Integer> map = Maps.newHashMap();

    public ZcQyYplxProGen(GraphIn graphIn) {
        super(graphIn);
        logger.info(ZcQyYplxProGen.toString());
    }
