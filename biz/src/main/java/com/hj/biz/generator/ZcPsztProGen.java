 ...
 */
public class ZcPsztProGen extends GraphGenerator{

    public static final BizKey ZcYplxProGen=new BizKey(105,"ÆÀÉó×´Ì¬","pie");

    Map<String,Integer> map = Maps.newHashMap();

    public ZcPsztProGen(GraphIn graphIn) {
        super(graphIn);
    ...
    protected void init() {
        ...
        for(CpmcZcDO ypPwBasicInfo:pws){
            String cplx=ypPwBasicInfo.getXb_pszt();
