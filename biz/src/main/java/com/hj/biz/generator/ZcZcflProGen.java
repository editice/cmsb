 ...
 */
public class ZcZcflProGen extends GraphGenerator{

    public static final BizKey ZcYplxProGen=new BizKey(104,"注册分类","pie");

    Map<String,Integer> map = Maps.newHashMap();

    public ZcZcflProGen(GraphIn graphIn) {
        super(graphIn);
    ...
    protected void init() {
        ...
        for(CpmcZcDO ypPwBasicInfo:pws){
            String cplx=ypPwBasicInfo.getZclx();
